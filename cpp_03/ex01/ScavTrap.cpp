...
ScavTrap::~ScavTrap(void)	{
	...
	std::string const	death[] = { " a cramé ses circuits.",
									" a trépassé.",
									" nous a quitté.",
	...
	std::cout << "SC4V-TP " << this->_name << ": ";
	std::cout << lines[std::rand() % 3] << std::endl;
	std::cout << "\e[31m";
	std::cout << "SC4V-TP " << this->_name << death[std::rand() % 7] << std::endl;
	std::cout << "\e[0m";
}
...
void	ScavTrap::passives(unsigned int amount)	{
	...
	(this->*passive[std::rand() % 2])(amount);
}
